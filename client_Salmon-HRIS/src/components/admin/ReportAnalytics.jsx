...
const ReportAnalytics = () => {
  ...
  const tabs = [
    ...
    { id: 'monthly', name: 'Monthly Recap', icon: '📅', color: 'green' },
    { id: 'overtime', name: 'Overtime', icon: '⏰', color: 'orange' },
    { id: 'leave', name: 'Leave', icon: '🏖️', color: 'purple' },
    { id: 'payroll', name: 'Payroll Support', icon: '💰', color: 'emerald' },
    { id: 'location', name: 'Location & GPS', icon: '📍', color: 'pink' },
    { id: 'audit', name: 'Audit Log', icon: '🔒', color: 'gray' },
    { id: 'compliance', name: 'Compliance', icon: '⚠️', color: 'red' }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border rounded-lg p-6">
        ...
        {activeTab === 'monthly' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">📅 Monthly Recap Report</h3>
        ...
        {activeTab === 'overtime' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">⏰ Overtime Report</h3>
        ...
        {activeTab === 'leave' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">🏖️ Leave Report</h3>
        ...
        {activeTab === 'payroll' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">💰 Payroll Support Report</h3>
        ...
        {activeTab === 'location' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">📍 Location & GPS Report</h3>
        ...
        {activeTab === 'audit' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">🔒 Audit Log Report</h3>
        ...
        {activeTab === 'compliance' && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">⚠️ Compliance / Violation Report</h3>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-red-800">
                <strong>⚠️ Smart Detection:</strong> Otomatis deteksi anomali dan pelanggaran untuk early warning!
              </p>
            </div>
