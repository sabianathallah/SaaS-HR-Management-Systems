                    ...
                    <tr key={attendance.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {attendance.clockInLatitude && attendance.clockInLongitude && (
                          ...
                          >
                            <MapPin size={14} className="inline mr-1" /> View Location
                          </button>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full inline-flex items-center gap-1 ${locationStatus.badge}`}>
        ...
        <form onSubmit={handleManualAttendance} className="space-y-4">
            ...
            {(formData.status === 'ON_TIME' || formData.status === 'LATE') && (
              <>
                ...
                <p className="text-xs text-gray-500 -mt-2">
                  Times will be combined with the selected date above
                </p>
              </>
            )}
            ...
            <FormSelect
              ...
              options={[
                ...
                { value: 'gps_error', label: 'GPS Error' },
              ]}
            />
        ...
        {selectedAttendance && (
          <div className="space-y-6">
            ...
            {selectedAttendance.clockInLatitude && selectedAttendance.clockInLongitude && (
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                  <span className="text-green-600 flex items-center gap-1"><Clock size={14} /></span> Clock In Location
                </h4>
                <div className="space-y-2">
                  ...
                  >
                    <ExternalLink size={14} className="inline mr-1" /> Open in Google Maps
                  </a>
                </div>
              </div>
            )}
            ...
            {selectedAttendance.clockOutLatitude && selectedAttendance.clockOutLongitude && (
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                  <span className="text-red-600 flex items-center gap-1"><Clock size={14} /></span> Clock Out Location
                </h4>
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="flex items-center gap-2">
                {(() => {
                  ...
                  return (
                    <span className={`px-3 py-1 rounded-full text-sm font-medium inline-flex items-center gap-1 ${status.badge}`}>
