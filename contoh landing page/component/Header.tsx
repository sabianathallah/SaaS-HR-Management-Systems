...
import { Menu, X, ChevronDown, Clock, DollarSign, Calendar, Users, BarChart, FileText, Target, Award, CheckCircle } from 'lucide-react';
...
export function Header({ onLoginClick, onTryFreeClick }: HeaderProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center flex-1 justify-between ml-10">
              {/* Left Side - Product, Features, Pricing */}
