                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 rounded-lg ${
                      ...
                      <Icon 
                        size={24} 
                        className={isSelected ? 'text-white' : 'text-[#1A9B9A]'} 
                      />
                    </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-4">
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-[#1A9B9A] rounded-full mt-2"></div>
                  <p className="text-gray-600">Real-time monitoring & tracking</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-[#1A9B9A] rounded-full mt-2"></div>
                  <p className="text-gray-600">Customizable workflows</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-[#1A9B9A] rounded-full mt-2"></div>
                  <p className="text-gray-600">Mobile app support</p>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-[#1A9B9A] rounded-full mt-2"></div>
